...
if (class_exists('ZendComment_Sniffs_Commenting_FileCommentSniff', true) === false) {
    $error = 'Class ZendComment_Sniffs_Commenting_FileCommentSniff not found';
    throw new PHP_CodeSniffer_Exception($error);
}
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class ZendComment_Sniffs_Commenting_ClassCommentSniff extends ZendComment_Sniffs_Commenting_FileCommentSniff
{
